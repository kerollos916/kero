...
public class roms3 extends AppCompatActivity {
    private AdView mAdView;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_roms3);
    ...
    public void good(View view) {
        ...
        startActivity(intent);
        Toast.makeText(getApplicationContext(),"اجابه صحيحه 100%",Toast.LENGTH_LONG).show();
    }

    public void rand(View view) {
        Intent intent = new Intent(this,roms03.class);
        startActivity(intent);
        Toast.makeText(getApplicationContext(),"اجابه ليست صحيحه ولاتستحق العقاب",Toast.LENGTH_LONG).show();
    }
    ...
    public void bad(View view) {
        ...
        Toast.makeText(getApplicationContext(),"اجابه خطاء تستحق العقاب",Toast.LENGTH_LONG).show();    }
}
