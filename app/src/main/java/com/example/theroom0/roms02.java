...
public class roms02 extends AppCompatActivity {
    private AdView mAdView;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_roms02);
    ...
    public void bad(View view) {
        ...
        Toast.makeText(getApplicationContext(),"اجابه خطاء تستحق العوده",Toast.LENGTH_LONG).show();
