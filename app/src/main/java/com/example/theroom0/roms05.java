...
public class roms05 extends AppCompatActivity {
    private AdView mAdView;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_roms05);
    ...
    public void ex(View view) {
        ...
        Toast.makeText(getApplicationContext(),"استطعت الخروج بسلام",Toast.LENGTH_LONG).show();
    ...
    public void rand(View view) {
        Intent intent = new Intent(this,roms5.class);
        startActivity(intent);
        Toast.makeText(getApplicationContext(),"اجابه اخرا صحيحه وتخرج",Toast.LENGTH_LONG).show();
    }

    public void bad(View view) {
        Intent intent = new Intent(this,roms4.class);
        startActivity(intent);


        Toast.makeText(getApplicationContext(),"اقتربت من الخروج ولاكن اجابتك خطاء",Toast.LENGTH_LONG).show();
