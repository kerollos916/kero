...
public class roms1 extends AppCompatActivity {
    private AdView mAdView;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_roms1);
    ...
    public void good(View view) {
        ...
        startActivity(intent);
        Toast.makeText(getApplicationContext(),"اجابه صحيحه 75%",Toast.LENGTH_LONG).show();
    }
