...
public class roms5 extends AppCompatActivity {
    private AdView mAdView;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_roms5);
    ...
    public void rand(View view) {
        Intent intent = new Intent(this,roms05.class);
        startActivity(intent);
        Toast.makeText(getApplicationContext(),"السؤال الاخير",Toast.LENGTH_LONG).show();
    }
